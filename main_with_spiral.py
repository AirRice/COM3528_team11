...
class Client:
    ...
    walk_type = "random" # Change walk type here spiral or random
    ...
    def spiral_walk(self, iterations):
            ...
            self.spiral_call += 100
            radius_increase =  (self.spiral_call // iterations)
            self.left_velocity =  self.left_velocity * (1 - self.radius_increase)
            self.right_velocity = self.right_velocity * (1 + self.radius_increase)

            if self.left_velocity < self.MAX_WHEEL_SPEED and self.right_velocity < self.MAX_WHEEL_SPEED:
            ...
            # ------For Testing -------
            print ("Radius Increase: " + self.radius_increase)
            print ("Spiral Call Count: " + self.spiral_call)
            print ("Iterations: " + iterations)
            print ("Left Velocity: " + self.left_velocity)
            print ("Right Velocity: " + self.right_velocity)
